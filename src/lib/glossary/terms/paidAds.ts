...
const seeds: Seed[] = [
  ...
  },
  {
    ...
    seo: {
      heroNote:
        "Use this page for the fast definition. If you are checking overall marketing health first, read the MER guide; if you are deciding whether to add the next dollars of spend, continue into the marginal ROAS guide.",
      nextStepLabel: "Read the marginal ROAS guide",
      nextStepHref: "/guides/marginal-roas-guide",
    },
    ...
    relatedGuideSlugs: ["marginal-roas-guide", "mer-guide"],
